...
Adapters não explíticos implementados como métodos: 
...
- https://docs.oracle.com/javase/8/javafx/api/javafx/beans/property/adapter/package-summary.html[um pacote inteiro de adapters para apps Desktop com JavaFX]
