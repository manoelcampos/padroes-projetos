...
=== Adaptando a aplicação de consulta de CEP (link:https://kinolien.github.io/gitzip/?download=/manoelcampos/quarkus-cep-services/tree/master/cep-service-producer[zip])
...
Alternativamente, veja o projeto link:cepservicep-adapter-spring-automatico[cepservicep-adapter-spring-automatico], 
