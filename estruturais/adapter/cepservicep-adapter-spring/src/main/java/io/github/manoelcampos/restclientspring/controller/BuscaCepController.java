package io.github.manoelcampos.restclientspring.controller;

import io.github.manoelcampos.restclientspring.model.Endereco;
import io.github.manoelcampos.restclientspring.service.BuscaCepService;
...
public class BuscaCepController {
    @Value("buscacep.baseurl")
    private String cepServiceBaseUrl;
    ...
    public Endereco buscaEndereco(@PathVariable String cep){
        System.out.println("Fazendo busca de CEP usando serviço " + cepServiceBaseUrl);
