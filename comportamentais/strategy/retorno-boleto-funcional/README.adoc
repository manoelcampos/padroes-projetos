...
IMPORTANT: Uma apresentação sobre as questões de programação funcional deste projeto está disponível https://docs.google.com/presentation/d/e/2PACX-1vRzqcUXSv7IRqhFo0zPmeS8OY17NG4LplA6ZNRQ6lTI02IYteX5t2EJTsmP_24xsYPBONE6WvarLWYH/pub?start=false&loop=false&delayms=3000[aqui].
