...
= Padrão de Projetos Template Method image:images/template-large.png[link=https://www.flaticon.com/authors/monkik]: Quase tudo que precisa saber (com exemplos em Java 8+) 🙌🏼
