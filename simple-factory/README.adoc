...
Baseado no projeto link:../template-method/retorno-boleto-funcional[retorno-boleto-funcional], vamos implementar a Simple Factory.

//O código fonte do projeto está disponível aqui link:xxx[].
