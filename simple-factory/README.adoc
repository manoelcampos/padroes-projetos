...
// O código fonte com uma implementação de exemplo pode ser obtido link:xxxx[aqui]. Tente primeiro fazer sua implementação a partir da leitura do diagrama,para depois analisar o código disponibilizado.
