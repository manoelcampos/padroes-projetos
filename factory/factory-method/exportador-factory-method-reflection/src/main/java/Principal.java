...
public class Principal {
    ...
    private static void exportarUsuarios() {
        ...
        final ExportadorLista exportadorPadrao = ExportadorLista.newInstance(USUARIOS);
        ColunaTabela<Usuario> coluna = exportadorPadrao.newColuna();
        ...
        final ExportadorLista exportadorMarkdown = ExportadorLista.newInstance(USUARIOS, "md");
    ...
    private static void exportarProdutos() {
        final ExportadorLista exportadorPadrao = ExportadorLista.newInstance(PRODUTOS);
        System.out.println("Lista de Produtos em HTML----------------------------------------------------------\n");
        System.out.println(exportadorPadrao.exportar());

        final ExportadorLista exportadorMarkdown = ExportadorLista.newInstance(PRODUTOS, "md");
