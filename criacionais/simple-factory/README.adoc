...
Assim, podemos dizer que `Cliente` depende indiretamente do `TipoAbstrato` (no sentido de que não é ela que cria
...
.Dependência indireta da Classe Cliente com o TipoAbstrato
